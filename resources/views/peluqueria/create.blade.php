...
<div class="container">
    <div class="card">
        ...
        <form action="{{url('/peluqueria')}}" class="form" method="post" enctype="multipart/form-data">
            ...
            <div class="col-md-11 mx-auto ">
                <div class=" row justify-content-center">
                    <div class="col-5">
                        ...
                        <select name="carnetBuscar" id="carnetBuscar" class="form-control {{$errors->has('recepcion')?'is-invalid':''}}">
                            <option selected disabled>Seleccione el Número de Carnet de Identidad</option> 
                    ...
                    <div class="col-5">
                        ...
                        <label for="nombrePaciente" class="control-label">{{'Nombre de Mascota'}}</label>
                        <select name="nombrePaciente" id="nombrePaciente" class="form-control {{$errors->has('nombrePaciente')?'is-invalid':''}}" >
                            <option selected disabled>Seleccione el Nombre de la Mascota</option> 

                            
                            
                            </select><span id="estadoNombreMascota"></span>
